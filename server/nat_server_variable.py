...
"""
listen_proxy_port_dict[proxy_port] = {
...
"""
listen_proxy_port_dict              = {}

"""
conn_nat_socket_fd_dict[conn_socket.fileno()] = {
    NAT_PARSER_REQUEST: EMPTY_MERGE_CUMULATOR,
    SOCKET_KEY: conn_socket
}
"""
conn_nat_socket_fd_dict             = {}

"""
conn_proxy_socket_fd_dict[conn_proxy_socket.fileno()] = {
    HTTP_PARSER_REQUEST: HttpParser(),
    HTTP_PARSER_RESPONSE: HttpParser(),
    SOCKET_KEY: conn_proxy_socket
}
"""
conn_proxy_socket_fd_dict           = {}
